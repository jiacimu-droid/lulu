...
/**
 * Compatibility holder for the chapter execution order used by AI scheduling.
 *
 * The retired recovery plan itself has been deleted: this object contains no
 * dates, daily tasks, weekly replacements, monthly replacements or state
 * mutation hooks. All visible and persisted plans now come from
 * [SummerCourseDeadlinePlan] through [StudyPlanCatalog].
 */
