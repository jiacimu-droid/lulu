...
object ExamStudyPlan {
    ...
    val studyHabitReference = """
        ...
        - 设定每天学习时长前必须先算完整总账：剩余原始课程分钟 ÷ 实际有效速度，再加章节题、错因、正式框架、三轮背诵、英语和政治，扣除每周休息与缓冲日后计算所需日均。最近完成量只决定爬坡起点，不能决定长期上限。
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-17", "3.5 小时增长日：刑法3-7题组 + 连接框架 + 英语", "确认第 3-7 章课程全部结束后，完成合并题第一大块 80 分钟并标主错因；未结束就补第 7 章课程", "正式连接框架图完成主干、章节连接和易混点 40 分钟", "法理第 1 章闭卷回忆 30 分钟", dailyVocabularyTaskTitle, dailyLongSentenceTaskTitle, "不熬夜硬清，剩余题目顺延"),
