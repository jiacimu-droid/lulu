...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-06", "刑法1继续 + 民法1入口", "刑法学第 1 章：听众合法硕刑法课程 75-90 分钟，作为第 3 个切片，听完补构成要件小框架", "民法第 1 章：听众合法硕民法课程 30-45 分钟，抓主体和民事法律关系入口", "民法第 1 章：只写 3-5 个入口关键词和 1 个不懂点，不急着做整章题", "英语：不背单词按 20 个一组做 6 组，错词只标记不抄写", "饭后放一首歌做手势舞或原地踏步 5-8 分钟，等困劲过去再回桌面"),
        ...
        daily("2026-07-09", "法理6 + 民法1第2切片", "法理学第 6 章：用考试分析做目录树第一轮背诵，并补 3 个不稳关键词", "民法第 1 章：听众合法硕民法课程 60-75 分钟，作为第 2 个切片，课后只留关键词和不懂点", "背诵：刑法第 1 章已听关键词 10 分钟，不背完整表述", "画民法第 1 章主体/法律关系入口框架", dailyLongSentenceTaskTitle, "饭后开窗站一会儿，配音乐转肩、转腰、脚踝绕圈 8-10 分钟"),
        ...
        daily("2026-07-11", "民法1继续 + 刑法1收口准备", "民法第 1 章：听众合法硕民法课程 60-75 分钟，作为第 3 个切片，课后只留关键词和小框架", "刑法学第 1 章：回看已听切片，列出整章章节题前还缺哪些知识点", "背诵：民法第 1 章关键词 15 分钟，只背入口概念", "画民法法律关系框架", dailyLongSentenceTaskTitle, "饭后洗漱 + 手势舞一首歌，热天不强迫出门"),
