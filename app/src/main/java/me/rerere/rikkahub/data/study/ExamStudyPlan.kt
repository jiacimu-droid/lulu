...
object ExamStudyPlan {
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            ...
            "稳启动：7月就开始背诵和章节闭环",
            listOf(
                "章节/课时：法理 $legalTheoryChapterCount 章找回；刑法第 1 章已看完并转章节题/错题/框架/第一轮背诵，刑法第 2 章至少完成 3 个主块，第 3 章进入 2 个主块，第 4 章只作可选入口；民法第 1 章连续听完并闭环，第 2 章至少完成 3 个主块，第 3 章进入 2 个主块；宪法/法制史第 1-2 章入口；加量按周递进，不突然堆满某一天",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-17", "法理9 + 刑法2第2主块", "法理学第 9 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "刑法学第 2 章：听众合法硕刑法课程 60-75 分钟，作为第 2 个主块，课后只留关键词和不懂点", "法制史第 1 章：只做 20-30 分钟入口预览，抓朝代线索，不硬听长课", "背诵：法理第 1-8 章第二次滚动，只背目录和关键词", "英语阅读预备：从真题阅读里摘 1 句长难句拆解", "天气凉快就散步 15-20 分钟，天气热就手势舞一首歌"),
        ...
        daily("2026-07-20", "法理11 + 民法2第3主块", "法理学第 11 章：用考试分析和错题本回看、框架整理、第一轮关键词背诵", "民法第 2 章：听众合法硕民法课程 60-75 分钟，作为第 3 个主块；如果状态差，就缩成 45 分钟并补关键词", "宪法第 1 章、法制史第 1 章：各 10-15 分钟关键词保温，只背入口概念和时间线", "整理宪法/法制史入门框架", "英语：田静《句句真研》或真题阅读句子 1 句长难句", "饭后不做硬背诵，先听音乐慢走或寝室轻舞 10 分钟"),
