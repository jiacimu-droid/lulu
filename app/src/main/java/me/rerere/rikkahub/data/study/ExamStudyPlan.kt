...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-15", "3.5 小时起步：刑法5收口 + 2章框架 + 英语长难句", "继续听众合法硕刑法第 5 章课程约 45-60 分钟，按原始 270 分钟课程账本核对剩余小节；未听完就继续第 5 章，不提前开第 6 章", "刑法第 2 章正式框架图收口 35 分钟；第 2 章是独立闭环，不与第 3-7 章连接图混在一起", "法理第 1 章闭卷背诵 30 分钟，复述目录树并补 2 句规范表述", dailyVocabularyTaskTitle, dailyLongSentenceTaskTitle, "广播体操或轻走 15 分钟；不因未清题组熬夜"),
