...
object ExamStudyPlan {
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-08", "休息后承接：刑法1闭环 + 民法1预览", "顺延自 7 月 7 日：刑法第 1 章：做文运/众合章节题 10-15 题，只标 1 个主错因，不再补听课", "刑法第 1 章：画一张方便背诵的犯罪论入口框架/思维导图，只保留主干、构成要件和易混点", "民法第 1 章：课前目录预览 10-15 分钟，标出主体、民事法律关系、权利义务这几个入口词，不急着做题", "法理第 1-3 章：只回看错题和目录背诵卡点，封口 10-15 分钟", dailyVocabularyTaskTitle, "饭后只做手势舞一首歌或整理桌面，不开新课"),
