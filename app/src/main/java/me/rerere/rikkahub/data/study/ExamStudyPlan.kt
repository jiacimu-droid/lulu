...
object ExamStudyPlan {
    ...
    val subjectExecutionReference = """
        ...
        - 专业课每章流程：课前 5 分钟看考试分析目录；听众合法硕课程 60-90 分钟切片；切片后写 3-5 个关键词、1 个不懂点或 1 张小框架；整章听完后再做章节题（一张约 $chapterPracticeQuestionsPerSet 道，可拆成 2-3 次）；错题只标 1 个主错因；最后回到考试分析标出选择题陷阱、简答/分析/案例/论述答题骨架、第一轮关键词背诵和 1-2 句规范表述。
    ...
    val monthlyPlans = listOf(
        MonthlyStudyPlan(
            ...
            listOf(
                ...
                "背诵：考试分析已到手，法理 13 章第一轮目录树和关键词走完；刑民只对闭环章节做第一轮关键词，并从考试分析补定义、构成要件和 1-2 句规范表述；宪法或法制史只择一背入口关键词；每天至少 20-30 分钟，不等听完全部课",
                "题目/真题：闭环章节当天或次日做章节题，一张按约 $chapterPracticeQuestionsPerSet 道估算，可拆 2-3 次完成并标主错因；每个闭环章从考试分析标选择题陷阱和简答/分析/案例/论述答题骨架；7 月不做完整 3 小时套卷，真题只做高频点锚定",
        ...
        MonthlyStudyPlan(
            ...
            listOf(
                ...
                "背诵：每天 40-60 分钟第一轮；法理弱章二次回炉；刑民闭环一章背一章；闭环章必须从考试分析留下答题骨架和 1-2 句规范表述；月底列五科未闭环章和最不稳 30 点",
                "题目/真题：整章闭环后做文运/众合章节题，错题写“知识点 + 错因 + 回炉日期”；每周更新真题高频点表，并区分选择题陷阱和主观题 90 分的表达入口",
        ...
        MonthlyStudyPlan(
            ...
            listOf(
                ...
                "题目/真题：章节题转错题回炉和分题型训练；每周 2-3 次主观题短答，覆盖专业基础课分析题/案例分析和综合课简答/分析/论述，先练开口、踩点和规范表述",
        ...
        MonthlyStudyPlan(
            ...
            listOf(
                ...
                "题目/真题：历年真题分科训练，每周至少 2 次主观题闭卷输出，并按每张卷 3 小时节奏拆分选择题、简答/分析/案例/论述小限时，做完当天回到具体章节和背诵漏洞",
    ...
    val julyWeeks = listOf(
        ...
        WeeklyStudyPlan(
            ...
            tasks = listOf(
                ...
                "刑法第 1 章已完成听课：本周完成文运/众合章节题 1 张约 $chapterPracticeQuestionsPerSet 道，7 月 8 日先做 15-20 道启动，7 月 13 日补完剩余 20-25 道并整理错因，再回到考试分析标选择题陷阱、案例分析入口和犯罪论答题骨架，画一张方便背诵的犯罪论入口框架/思维导图",
                "刑法第 2 章暂不抢民法第 1 章连续主块；等刑法第 1 章做题和框架闭环、民法第 1 章至少完成 2-3 个主块后，再开 1 个入口切片",
                "民法第 1 章从零启动：连续安排 2-3 个众合法硕课程主块，课前用已到手考试分析抓主体、民事法律关系和入口概念；整章未闭环前不刷章节题，但可标简答/分析题答题骨架",
    ...
    val dailyPlans: Map<LocalDate, DailyStudyPlan> = listOf(
        ...
        daily("2026-07-08", "休息后承接：刑法1闭环启动 + 民法1预览", "顺延自 7 月 7 日：刑法第 1 章：做文运/众合章节题 15-20 道，只算启动量，不算完整闭环；每道错题只标 1 个主错因，不再补听课", "刑法第 1 章：回到考试分析标出犯罪论的选择题陷阱、构成要件、案例分析入口和简短答题骨架，再画一张方便背诵的犯罪论入口框架/思维导图", "民法第 1 章：用已到手考试分析做课前目录预览 10-15 分钟，标出主体、民事法律关系、权利义务这几个入口词，不急着做题", "法理第 1-3 章：正式背诵 30-40 分钟，先看错题卡点 5 分钟，再合上书口头复述目录树和关键词，卡住只看 10 秒提示继续说", dailyVocabularyTaskTitle, "饭后只做手势舞一首歌或整理桌面，不开新课；今天有效学习量至少凑够 2 小时"),
        daily("2026-07-09", "民法1连续主块：第1主块 + 法理5封口", "民法第 1 章：先看考试分析目录 5 分钟，再听众合法硕民法课程 75-90 分钟，作为民法连续单元第 1 个主块，抓主体、民事法律关系和权利义务入口", "民法第 1 章：课后只留 3-5 个关键词、1 个不懂点、一个主体/法律关系小框架，并标 1 个可能的简答或分析题答题骨架，不急着做整章题", "法理学第 5 章：用考试分析和错题本回看目录、框架、关键词，完成第一轮背诵痕迹", "刑法第 1 章：只复述章节题错因和框架 10 分钟，保温但不新开大块", dailyLongSentenceTaskTitle, "饭后开窗站一会儿，配音乐转肩、转腰、脚踝绕圈 8-10 分钟"),
