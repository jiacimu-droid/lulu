...
- 基准提交：`79a2db8d62cc039c42e0278fdc145a1f4dec3ef3`
- 分支：`master`
- 源码指纹：`417ec2c3f83c4a39…`
- 已索引文件：1130
- 已索引代码/文本行：266005
- 已发现类、接口、对象、函数及 Composable：5548
...
| `app/src/main/java/me/rerere/rikkahub/data/model/Assistant.kt` | 50 | 331 |
