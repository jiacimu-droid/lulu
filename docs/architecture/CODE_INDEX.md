...
- 基准提交：`4e7dc4051f5aafe4ed5d2ec4aa572e54e39a9ffe`
- 分支：`master`
- 源码指纹：`0c31285c47342214…`
- 已索引文件：1161
- 已索引代码/文本行：268458
- 已发现类、接口、对象、函数及 Composable：5605
...
| `app/src/main/java/me/rerere/rikkahub/data/datastore/PreferencesStore.kt` | 106 | 953 |
