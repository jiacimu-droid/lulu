...
- 基准提交：`8e4b0f790a666722199f413f3fa43aee0421aa19`
- 分支：`master`
- 源码指纹：`37450fb2f8f2f21f…`
- 已索引文件：1162
- 已索引代码/文本行：268676
- 已发现类、接口、对象、函数及 Composable：5606
...
| `app/src/main/java/me/rerere/rikkahub/data/datastore/PreferencesStore.kt` | 107 | 953 |
