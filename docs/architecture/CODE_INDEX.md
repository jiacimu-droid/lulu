...
- 基准提交：`397edf891e16dad794995124d3bf0882776d1aef`
- 分支：`master`
- 源码指纹：`951aea005d0decf3…`
- 已索引文件：1130
- 已索引代码/文本行：265907
- 已发现类、接口、对象、函数及 Composable：5544
...
| `app/src/main/java/me/rerere/rikkahub/data/model/Assistant.kt` | 48 | 295 |
