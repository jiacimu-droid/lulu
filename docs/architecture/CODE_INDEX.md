...
- 基准提交：`5ba13b15a33596f52f6daaef270590f1518384b9`
- 分支：`master`
- 源码指纹：`48fc1ccc53833e2f…`
- 已索引文件：1163
- 已索引代码/文本行：268893
- 已发现类、接口、对象、函数及 Composable：5609
...
| `app/src/main/java/me/rerere/rikkahub/data/datastore/PreferencesStore.kt` | 108 | 953 |
